...
public class ProductsService {
    ...
    public List<Products> getAllGaming() {
        return repository.findByGamingIsTrue();
    }
    public List<Products> getAllRjPlus() {
        return repository.findByRjPlusIsTrue();
    }

    public List<Products> getAllBestSelling() {
